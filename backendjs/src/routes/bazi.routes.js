...
router.post('/matching/ai', async (req, res) => {
    try {
        ...
        if (authHeader && authHeader.startsWith('Bearer ')) {
            try {
                ...
                const { getSession } = require('../services/database.service');
        ...
        const result = await aiService.generateMatchingAnswer(ctx1, ctx2, relationship, persona);
